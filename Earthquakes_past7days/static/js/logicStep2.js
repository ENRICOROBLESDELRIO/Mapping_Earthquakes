...
// Create the map object with center of USA
let map = L.map('mapid', {
  center: [39.5, -98.5],
  zoom: 3,
  layers: [streets]
...
// The getRadius() function retrieves the earthquake's magnitude. 
// Next, we'll create the getRadius() function to calculate the radius of the circle from the magnitude.
